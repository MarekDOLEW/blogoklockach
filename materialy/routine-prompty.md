...
odczyt z konta: 22.09.2026, 08:13 (CEST). Nie edytuj ręcznie — źródłem prawdy
...
## LEGO pon 08:00 — Harmonogram z konta (sesja Code, list_triggers)

- ID: `trig_01GJ2ecMp3gwtkZ1pFyUPKLH` · cron `0 6 * * 1` (UTC) · włączony · stała sesja (zmiana promptu = delete + create)
...
- ID: `trig_01UjqSHw15xGcvVpQmkfqESZ` · cron `0 7 * * 1` (UTC) · włączony · stała sesja (zmiana promptu = delete + create)
...
## Raport kontrolera — wynik tygodnia

- ID: `trig_012F22qZPFRvBhxG2HUG9puV` · cron `0 7 * * 1` (UTC) · włączony · świeża sesja na każdy przebieg
